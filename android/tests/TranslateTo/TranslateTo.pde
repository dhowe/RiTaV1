...
import rita.*;
  ...
  public void setup()
  {
    ...
    rt5 = new RiText(this, "Rotate Delay2s",500,300);
    rt5.fill(255,0,0);
    rt5.rotateTo(-2,2,2);
    
    rt6 = new RiText(this, "Rotate",300,300);
    rt6.fill(255,0,0);
    rt6.rotateTo(0.5f,1);
    ...
    rt9 = new RiText(this, "Scale",50,700);
    rt9.fill(0,200,0);
    rt9.scaleTo(1.5f,2);
    
    RiText rt10 = new RiText(this, "Scale Delay2s",300,700);
    rt10.fill(0,200,0);
