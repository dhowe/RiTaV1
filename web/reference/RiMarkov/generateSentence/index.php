				...
				<div class="span11">
					<table cellpadding="0" cellspacing="0" border="0" class="ref-item">
						...
						<tr class="">
							...
							<!-- DESCRIPTION  -->
							<td>Generates a single sentence from the model</td>
						</tr>
						...
						<tr class='Syntax'>
							...
							<!-- SYNTAX  -->
							<td><pre>generateSentence();</pre></td>
						</tr>
						...
						<tr class='Example'>
							...
							<div class="example">
								...
								<pre class="margin">rm = new RiMarkov(3);<br>rm.loadText(theText);<br>sentences = rm.generateSentence();</pre>
							</div></td>
						</tr>
