				...
				<div class="span11">
					<table cellpadding="0" cellspacing="0" border="0" class="ref-item">
						...
						<tr class="">
							...
							<!-- DESCRIPTION  -->
							<td>Returns up to maxResults of the specified pos that match the soundex code of the given word.</td>
						</tr>
						...
						<tr class='Syntax'>
							...
							<!-- SYNTAX  -->
							<td><pre>getSoundsLike(pattern, posStr);<br/>getSoundsLike(pattern, posStr, maxResults);</pre></td>
						</tr>
