				...
				<div class="span11">
					<table cellpadding="0" cellspacing="0" border="0" class="ref-item">
						...
						<tr class="">
							...
							<!-- DESCRIPTION  -->
							<td>Returns part-to-whole relationships for 1st sense of word/pos, or none if not found<br>X is a meronym of Y if Y has X as a part.<br>X is a holonym of Y if X has Y as a part. That is, if Y is a meronym of X. <br>Holds between: nouns and nouns<br>Returns part, member, and substance holonyms<br>Example: arm -> [body, physical-structure, man, human...]</td>
						</tr>
						...
						<tr class='Syntax'>
							...
							<!-- SYNTAX  -->
							<td><pre>getHolonyms(id);<br/>getHolonyms(query, pos);</pre></td>
						</tr>
