				...
				<div class="span11">
					<table cellpadding="0" cellspacing="0" border="0" class="ref-item">
						...
						<tr class="">
							...
							<!-- DESCRIPTION  -->
							<td>Returns Hypernym String[] for the id or word/pos pair<p>X is a hyponym of Y if there exists an is-a relationship between X and Y.<br>That is, if X is a subtype of Y. <br>Or, for example, if X is a species of the genus Y. <br>X is a hypernym of Y is Y is a hyponym of X. <br>Holds between: nouns and nouns & verbs and verbs<br>Examples:<ul><li>artifact is a hyponym of object<li>object is a hypernym of artifact<li>carrot is a hyponym of herb<li>herb is a hypernym of carrot</ul></td>
						</tr>
						...
						<tr class='Syntax'>
							...
							<!-- SYNTAX  -->
							<td><pre>getHypernyms(id);<br/>getHypernyms(word, posStr);</pre></td>
						</tr>
						...
						<tr class='Parameters'>
							...
							<table cellpadding="0" cellspacing="0" border="0" class="sub-table">
								<tr class=''><th width='25%' scope='row' class=nobold>int</th><td width='75%'>id</td></tr><tr class=''><th width='25%' scope='row' class=nobold>String</th><td width='75%'>word</td></tr><tr class=''><th width='25%' scope='row' class=nobold>String</th><td width='75%'>posStr</td></tr>
							</table></td>
						</tr>
