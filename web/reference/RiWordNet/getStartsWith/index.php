				...
				<div class="span11">
					<table cellpadding="0" cellspacing="0" border="0" class="ref-item">
						...
						<tr class="">
							...
							<!-- DESCRIPTION  -->
							<td>Returns up to maxResults of the specified pos starting with the given word.<br/>Example: 'turn' returns 'turntable'</td>
						</tr>
						...
						<tr class='Syntax'>
							...
							<!-- SYNTAX  -->
							<td><pre>getStartsWith(word, posStr);<br/>getStartsWith(word, posStr, maxResults);</pre></td>
						</tr>
