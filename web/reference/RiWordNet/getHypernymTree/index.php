				...
				<div class="span11">
					<table cellpadding="0" cellspacing="0" border="0" class="ref-item">
						...
						<tr class="">
							...
							<!-- DESCRIPTION  -->
							<td>Returns a String[] of hypernym-synsets (each a colon-delimited String) representing the path from the input node to the root of the ontology</td>
						</tr>
						...
						<tr class='Syntax'>
							...
							<!-- SYNTAX  -->
							<td><pre>getHypernymTree(id);</pre></td>
						</tr>
