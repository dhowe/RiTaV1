				...
				<div class="span11">
					<table cellpadding="0" cellspacing="0" border="0" class="ref-item">
						...
						<tr class="">
							...
							<!-- DESCRIPTION  -->
							<td>Returns similar-to list for all sense of word/pos<br/>Holds for adjectives<br/>Example:<br/>happy(a) -> [blessed, blissful, bright, golden, halcyon, prosperous...]</td>
						</tr>
						...
						<tr class='Syntax'>
							...
							<!-- SYNTAX  -->
							<td><pre>getAllSimilar(query, pos);</pre></td>
						</tr>
