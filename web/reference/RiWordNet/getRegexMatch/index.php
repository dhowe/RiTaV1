				...
				<div class="span11">
					<table cellpadding="0" cellspacing="0" border="0" class="ref-item">
						...
						<tr class="">
							...
							<!-- DESCRIPTION  -->
							<td>Returns up to maxResults of the specified pos Example: '.*table' returns 'turntable' & 'uncomfortable'</td>
						</tr>
						...
						<tr class='Syntax'>
							...
							<!-- SYNTAX  -->
							<td><pre>getRegexMatch(pattern, posStr);<br/>getRegexMatch(pattern, posStr, maxResults);</pre></td>
						</tr>
