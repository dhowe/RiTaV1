				...
				<div class="span11">
					<table cellpadding="0" cellspacing="0" border="0" class="ref-item">
						...
						<tr class="">
							...
							<!-- DESCRIPTION  -->
							<td>Returns all 'contains' matches for the specified word and pos <br/>Example: 'table' returns 'bleat' (but not 'tale').</td>
						</tr>
						...
						<tr class='Syntax'>
							...
							<!-- SYNTAX  -->
							<td><pre>getContains(word, posStr);<br/>getContains(word, posStr, maxResults);</pre></td>
						</tr>
