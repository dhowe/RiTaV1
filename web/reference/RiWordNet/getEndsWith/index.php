				...
				<div class="span11">
					<table cellpadding="0" cellspacing="0" border="0" class="ref-item">
						...
						<tr class="">
							...
							<!-- DESCRIPTION  -->
							<td>Returns up to maxResults of the specified pos ending with the given word.<br/>Example: 'table' returns 'turntable' & 'uncomfortable'</td>
						</tr>
						...
						<tr class='Syntax'>
							...
							<!-- SYNTAX  -->
							<td><pre>getEndsWith(word, posStr);<br/>getEndsWith(word, posStr, maxResults);</pre></td>
						</tr>
