				...
				<div class="span11">
					<table cellpadding="0" cellspacing="0" border="0" class="ref-item">
						...
						<tr class="name-row">
							...
							<!-- METHOD NAME -->
							<td><h3>getAllNominalizations</h3></td>
						</tr>
						...
						<tr class="">
							...
							<!-- DESCRIPTION  -->
							<td>Returns nominalized terms for all sense of word/pos<br/>Refers to the use of a verb or an adjective as a noun. Holds for nouns, verbs & adjecstives(?)<br/>Example: happiness(n) -> [happy, unhappy]<br/>happy(a) -> [happiness, felicity]</td>
						</tr>
						...
						<tr class='Syntax'>
							...
							<!-- SYNTAX  -->
							<td><pre>getAllNominalizations(query, pos);</pre></td>
						</tr>
