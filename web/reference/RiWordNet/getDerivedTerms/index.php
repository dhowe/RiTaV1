				...
				<div class="span11">
					<table cellpadding="0" cellspacing="0" border="0" class="ref-item">
						...
						<tr class="">
							...
							<!-- DESCRIPTION  -->
							<td>Returns derived terms for the id or word/pos pair<br>Holds for adverbs <br>Example: happily -> [jubilant, blithe, gay, mirthful, merry, happy]</td>
						</tr>
						...
						<tr class='Syntax'>
							...
							<!-- SYNTAX  -->
							<td><pre>getDerivedTerms(id);<br/>getDerivedTerms(query, pos);</pre></td>
						</tr>
