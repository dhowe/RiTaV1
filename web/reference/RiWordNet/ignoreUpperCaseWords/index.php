				...
				<div class="span11">
					<table cellpadding="0" cellspacing="0" border="0" class="ref-item">
						...
						<tr class="name-row">
							...
							<!-- METHOD NAME -->
							<td><h3>ignoreUpperCaseWords</h3></td>
						</tr>
						...
						<tr class="">
							...
							<!-- DESCRIPTION  -->
							<td>Set RiWordNet to ignore uppercase words</td>
						</tr>
						...
						<tr class='Syntax'>
							...
							<!-- SYNTAX  -->
							<td><pre>ignoreUpperCaseWords(ignoreUpperCaseWords);</pre></td>
						</tr>
						...
						<tr class='Parameters'>
							...
							<table cellpadding="0" cellspacing="0" border="0" class="sub-table">
								<tr class=''><th width='25%' scope='row' class=nobold>boolean</th><td width='75%'>a flag specifying whether to include uppercase words in output, e.g., 'Fungi' ( (optional, for 'sets' only)</td></tr>
							</table></td>
						</tr>
