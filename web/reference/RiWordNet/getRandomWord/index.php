				...
				<div class="span11">
					<table cellpadding="0" cellspacing="0" border="0" class="ref-item">
						...
						<tr class="">
							...
							<!-- DESCRIPTION  -->
							<td>Returns a random stem with pos and a max length of this.maxCharsPerWord.</td>
						</tr>
						...
						<tr class='Syntax'>
							...
							<!-- SYNTAX  -->
							<td><pre>getRandomWord(pos);<br/>getRandomWord(pos, stemsOnly, maxChars);</pre></td>
						</tr>
						...
						<tr class='Parameters'>
							...
							<table cellpadding="0" cellspacing="0" border="0" class="sub-table">
								<tr class=''><th width='25%' scope='row' class=nobold>String</th><td width='75%'>the part-of-speech</td></tr><tr class=''><th width='25%' scope='row' class=nobold>boolean</th><td width='75%'>(Optional) stemsOnly</td></tr><tr class=''><th width='25%' scope='row' class=nobold>int</th><td width='75%'>(Optional) maxChars</td></tr>
							</table></td>
						</tr>
						...
						<tr class='Returns'>
							...
							<table cellpadding="0" cellspacing="0" border="0" class="sub-table">
								<tr class=''><th width='25%' scope='row' class=nobold>java.lang.String</th><td width='75%'>random word</td></tr>
							</table></td>
						</tr>
