				...
				<div class="span11">
					<table cellpadding="0" cellspacing="0" border="0" class="ref-item">
						<tr class="name-row">
							...
							<!-- ClASS -->
							<td><h3><a href="../../RiGrammar.php">RiGrammar</a></h3></td>
						</tr>
						...
						<tr class='Example'>
							...
							<div class="example">
								...
								<pre class="margin">rg = new RiGrammar(); <br> rg.addRule("<start>", "the <pet> | the <action> of the <pet>", 1);<br>rg.addRule("<pet>", "dog | hawk | crow", 1); <br>rg.addRule("<action>", "cries | screams | falls", 1);<br>println(rg.getGrammar());</pre>
							</div></td>
						</tr>
