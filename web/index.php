                  ...
                  <div class="gd-center pad-large">
                     <div class="row">
                        ...
                        <div class="col8 smgd-12 intro">
                           ...
                           <p class="supText"><sup>†</sup> from the old Norse, meaning to mark, scratch, or scribble</p>
                        </div>
                        <div class="col2"></div>
                     </div>
                  </div>
               ...
               <div class="gd-section pad-medium home bg2">
                  <div class="gd-center pad-large">
                     <div class="row">
                        <div class="col1"></div>
                        <div class="col10">
                           <h3 style="margin-left:-1rem">Features</h3>
                           <div class="row features">
                              ...
                              <div class="gd-4 mgd-6 sgd-12 feature">
                                 ...
                                 <p>Modules for tokenization,
                                    <br> verb conjugation, pluralization, and stemming
                                 </p>
                              </div>
                              <div class="gd-4 mgd-6 sgd-12 feature">
                                 <span class="icon-sound">
                                 </span>
                                 <p>User-customizable lexicon
                                    <br> with letter-to-sound phoneme generation
                                 </p>
                              </div>
                              <div class="gd-4 mgd-6 sgd-12 feature">
                                 <span class="icon-bookmark">
                                 </span>
                                 <p>Taggers for Syllables, Phonemes, Stress, Part-of-Speech, etc.</p>
                              </div>
                              <div class="gd-4 mgd-6 sgd-12 feature">
                                 <span class="icon-diamond"></span>
                                 <p>Runs in or outside the browser
                                    <br> with or without Processing
                                    <br>(also in Android)
                                 </p>
                              </div>
                              <div class="gd-4 mgd-6 sgd-12 feature">
                                 ...
                                 <p>Optionally integrates with
                                    <br> WordNet dictionary
                                    <br>(locally-installed)
                                 </p>
                              </div>
                           </div>
                        </div>
                        ...
                        <div class="col10">
                           ...
                           <div class="gallery_home">
                              <div class="row">
                                 ...
                                 <span class="gallery_home_item gd-4 mgd-6 sgd-12">
                                    <a href="http://rednoise.org/rita/gallery/MemoireInvolontaireNo1" target="new"><img src="img/memory.gif" width="180"></a><br>
