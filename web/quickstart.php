...
<div class="row">
  ...
  <div class="col10">
        ...
        <li><a href="https://github.com/dhowe/RiTaJS#with-bower" target="_blank">In the browser with bower</a></li>
            ...
            <li><a href="https://github.com/dhowe/RiTaJS#with-processingjs" target="_blank">In the browser with processing.js</a></li>
            </ul>

          <h5>Using RiTa in Java</h5>
          <ul>
          ...
          <h5>Development</h5>
          <ul>
            <li><a href="https://github.com/dhowe/RiTa#development-setup-in-eclipse" target="_blank">Eclipse (java) via git/ant</a></li>
