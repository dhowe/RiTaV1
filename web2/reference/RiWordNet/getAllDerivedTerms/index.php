				...
				<div class="span11">
					<table cellpadding="0" cellspacing="0" border="0" class="ref-item">
						...
						<tr class="name-row">
							...
							<!-- METHOD NAME -->
							<td><h3>getAllDerivedTerms</h3></td>
						</tr>
						...
						<tr class="">
							...
							<!-- DESCRIPTION  -->
							<td>Returns derived terms forall senses of word/pos<br/>Holds for adverbs <br/>Example: happily -> [jubilant, blithe, gay, mirthful, merry, happy]</td>
						</tr>
						...
						<tr class='Syntax'>
							...
							<!-- SYNTAX  -->
							<td><pre>getAllDerivedTerms(query, pos);</pre></td>
						</tr>
