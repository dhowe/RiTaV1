				...
				<div class="span11">
					<table cellpadding="0" cellspacing="0" border="0" class="ref-item">
						...
						<tr class="">
							...
							<!-- DESCRIPTION  -->
							<td>Returns similar-to list for the id or word/pos pair<br/>Holds for adjectives<br/>Example:happy(a) -> [blessed, blissful, bright, golden, halcyon, prosperous...]</td>
						</tr>
						...
						<tr class='Syntax'>
							...
							<!-- SYNTAX  -->
							<td><pre>getSimilar(id);<br/>getSimilar(query, pos);</pre></td>
						</tr>
						...
						<tr class='Parameters'>
							...
							<table cellpadding="0" cellspacing="0" border="0" class="sub-table">
								<tr class=''><th width='25%' scope='row' class=nobold>int</th><td width='75%'>(Optional) the id</td></tr><tr class=''><th width='25%' scope='row' class=nobold>String</th><td width='75%'>(Optional) the word</td></tr><tr class=''><th width='25%' scope='row' class=nobold>String</th><td width='75%'>(Optional) pos</td></tr>
							</table></td>
						</tr>
