				...
				<div class="span11">
					<table cellpadding="0" cellspacing="0" border="0" class="ref-item">
						...
						<tr class="">
							...
							<!-- DESCRIPTION  -->
							<td>Returns verb group for id<br/>Example: live -> [dwell, inhabit]; Holds for verbs</td>
						</tr>
						...
						<tr class='Syntax'>
							...
							<!-- SYNTAX  -->
							<td><pre>getVerbGroup(id);<br/>getVerbGroup(query, pos);</pre></td>
						</tr>
						...
						<tr class='Parameters'>
							...
							<table cellpadding="0" cellspacing="0" border="0" class="sub-table">
								<tr class=''><th width='25%' scope='row' class=nobold>String</th><td width='75%'>query</td></tr><tr class=''><th width='25%' scope='row' class=nobold>String</th><td width='75%'>(Optional) pos</td></tr>
							</table></td>
						</tr>
