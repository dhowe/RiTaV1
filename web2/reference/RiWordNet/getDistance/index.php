				...
				<div class="span11">
					<table cellpadding="0" cellspacing="0" border="0" class="ref-item">
						...
						<tr class='Syntax'>
							...
							<!-- SYNTAX  -->
							<td><pre>getDistance(lemma1, lemma2, pos);</pre></td>
						</tr>
						...
						<tr class='Parameters'>
							...
							<table cellpadding="0" cellspacing="0" border="0" class="sub-table">
								<tr class=''><th width='25%' scope='row' class=nobold>String</th><td width='75%'>first lemma</td></tr><tr class=''><th width='25%' scope='row' class=nobold>String</th><td width='75%'>second lemma</td></tr><tr class=''><th width='25%' scope='row' class=nobold>String</th><td width='75%'>the part-of-speech</td></tr>
							</table></td>
						</tr>
						...
						<tr class='Returns'>
							...
							<table cellpadding="0" cellspacing="0" border="0" class="sub-table">
								<tr class=''><th width='25%' scope='row' class=nobold>float</th><td width='75%'>distance normalized to 0 <= d < 1, or 1 if either is not found</td></tr>
							</table></td>
						</tr>
