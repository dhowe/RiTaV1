				...
				<div class="span11">
					<table cellpadding="0" cellspacing="0" border="0" class="ref-item">
						...
						<tr class="">
							...
							<!-- DESCRIPTION  -->
							<td>Finds the most common part-of-speech for a word based on its polysemy count, returning the pos for the version of the word with the most different senses.</td>
						</tr>
						...
						<tr class='Returns'>
							...
							<table cellpadding="0" cellspacing="0" border="0" class="sub-table">
								<tr class=''><th width='25%' scope='row' class=nobold>java.lang.String</th><td width='75%'>A single-character String for the most common part of speech ('a' = adjective, 'n' = noun, 'r' = adverb, 'v' = verb), or null if the word is not found.</td></tr>
							</table></td>
						</tr>
