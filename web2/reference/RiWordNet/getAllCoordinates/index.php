				...
				<div class="span11">
					<table cellpadding="0" cellspacing="0" border="0" class="ref-item">
						...
						<tr class="">
							...
							<!-- DESCRIPTION  -->
							<td>Returns coordinate terms for all sense of word/pos<br>X is a coordinate term of Y if there exists a term Z which is the hypernymof both X and Y.<br>Examples:<ul><li>blackbird and robin are coordinate terms (since they are both a kind ofthrush)<li>gun and bow are coordinate terms (since they are both weapons)<li>fork and spoon are coordinate terms (since they are both cutlery, oreating utensils)<li>hat and helmet are coordinate terms (since they are both a kind ofheadgear or headdress)</ul>Example: arm -> [hind-limb, forelimb, flipper, leg, crus, thigh, arm...]<br>Holds btwn nouns/nouns and verbs/verbs</td>
						</tr>
						...
						<tr class='Syntax'>
							...
							<!-- SYNTAX  -->
							<td><pre>getAllCoordinates(query, pos);</pre></td>
						</tr>
