				...
				<div class="span11">
					<table cellpadding="0" cellspacing="0" border="0" class="ref-item">
						...
						<tr class="">
							...
							<!-- DESCRIPTION  -->
							<td>Returns String[] of the words in the synset for the unique id or word/pos/sense-number. If only an id is supplied, the full synset for that id will be returned; if a word/pos/sense# is supplied, the synset for that sense will be returned; if no sense-number is supplied, the synset for the first sense will returned.</td>
						</tr>
						...
						<tr class='Syntax'>
							...
							<!-- SYNTAX  -->
							<td><pre>getSynset(id);<br/>getSynset(word, pos);<br/>getSynset(word, pos, senseNumber);<br/>getSynset(word, pos, senseNumber, includeOriginal);<br/>getSynset(word, pos, includeOriginal);</pre></td>
						</tr>
						...
						<tr class='Parameters'>
							...
							<table cellpadding="0" cellspacing="0" border="0" class="sub-table">
								<tr class=''><th width='25%' scope='row' class=nobold>int</th><td width='75%'>(Optional) the unique id</td></tr><tr class=''><th width='25%' scope='row' class=nobold>String</th><td width='75%'>(Optional) word</td></tr><tr class=''><th width='25%' scope='row' class=nobold>String</th><td width='75%'>(Optional) the pos</td></tr><tr class=''><th width='25%' scope='row' class=nobold>int</th><td width='75%'>(Optional) the senseNumber</td></tr><tr class=''><th width='25%' scope='row' class=nobold>boolean</th><td width='75%'>(Optional) includeOriginal -- whether to include the original word in the result array (default=false)</td></tr>
							</table></td>
						</tr>
