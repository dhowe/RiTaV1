				...
				<div class="span11">
					<table cellpadding="0" cellspacing="0" border="0" class="ref-item">
						...
						<tr class="name-row">
							...
							<!-- METHOD NAME -->
							<td><h3>getNominalizations</h3></td>
						</tr>
						...
						<tr class="">
							...
							<!-- DESCRIPTION  -->
							<td>Returns nominalized terms for the id or word/pos pair<br/>Refers to the use of a verb or an adjective as a noun. Holds for nouns, verbs & adjecstives(?)<br/>Example: happiness(n) -> [happy, unhappy]<br/>happy(a) -> [happiness, felicity]</td>
						</tr>
						...
						<tr class='Syntax'>
							...
							<!-- SYNTAX  -->
							<td><pre>getNominalizations(id);<br/>getNominalizations(query, pos);</pre></td>
						</tr>
						...
						<tr class='Parameters'>
							...
							<table cellpadding="0" cellspacing="0" border="0" class="sub-table">
								<tr class=''><th width='25%' scope='row' class=nobold>int</th><td width='75%'>id</td></tr><tr class=''><th width='25%' scope='row' class=nobold>String</th><td width='75%'>query</td></tr><tr class=''><th width='25%' scope='row' class=nobold>String</th><td width='75%'>the part-of-speech</td></tr>
							</table></td>
						</tr>
