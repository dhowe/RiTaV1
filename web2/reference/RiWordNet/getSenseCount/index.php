				...
				<div class="span11">
					<table cellpadding="0" cellspacing="0" border="0" class="ref-item">
						...
						<tr class="">
							...
							<!-- DESCRIPTION  -->
							<td>Return the # of senses (polysemy) for a given word/pos. A 'sense' refers to a specific WordNet meaning and maps 1-1 to the concept of synsets. Each 'sense' of a word exists in a different synset.<br/>For more info, see: {@link http://wordnet.princeton.edu/gloss}</td>
						</tr>
						...
						<tr class='Syntax'>
							...
							<!-- SYNTAX  -->
							<td><pre>getSenseCount(word, pos);</pre></td>
						</tr>
						...
						<tr class='Returns'>
							...
							<table cellpadding="0" cellspacing="0" border="0" class="sub-table">
								<tr class=''><th width='25%' scope='row' class=nobold>int</th><td width='75%'># of senses or 0 if not found</td></tr>
							</table></td>
						</tr>
