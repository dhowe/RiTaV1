				...
				<div class="span11">
					<table cellpadding="0" cellspacing="0" border="0" class="ref-item">
						...
						<tr class="">
							...
							<!-- DESCRIPTION  -->
							<td>Returns all full anagram matches for the specified word and pos<br/>Example: 'table' returns 'bleat' (but not 'tale').</td>
						</tr>
						...
						<tr class='Syntax'>
							...
							<!-- SYNTAX  -->
							<td><pre>getAlsoSees(senseId);<br/>getAlsoSees(query, pos);</pre></td>
						</tr>
						...
						<tr class='Parameters'>
							...
							<table cellpadding="0" cellspacing="0" border="0" class="sub-table">
								<tr class=''><th width='25%' scope='row' class=nobold>int</th><td width='75%'>senseId</td></tr><tr class=''><th width='25%' scope='row' class=nobold>String</th><td width='75%'>query</td></tr><tr class=''><th width='25%' scope='row' class=nobold>String</th><td width='75%'>the part-of-speech</td></tr>
							</table></td>
						</tr>
