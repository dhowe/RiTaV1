...
<body>
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-8"><h3 id="reference-title">Reference</h3> </div>
      <div class="col-md-2"> </div>
    </div>
  </div>
<div class="container">
  <div class="row">
    ...
    <div class="col-md-2">
      ...
      <a href="RiTa.php"><b>RiTa</b></a>

        <a href="RiTa/RiTa.VERSION/index.php">RiTa.VERSION</a>
        <br>
        <span class="empty" style=" line-height:8px; visibility:hidden"><br></span>
        ...
        <br>
        <a href="RiTa/RiTa.getPhonemes/index.php">RiTa.getPhonemes()</a>
        <br>
        <a href="RiTa/RiTa.getPosTags/index.php">RiTa.getPosTags() </a>
        <br>
        <a href="RiTa/RiTa.getPosTagsInline/index.php">RiTa.getPosTagsInline()</a>
        <br>
        <a href="RiTa/RiTa.getPresentParticiple/index.php">RiTa.getPresentParticiple()</a>
        <br>
        <a href="RiTa/RiTa.getStresses/index.php">RiTa.getStresses()</a>
        <br>
        ...
        <div class="reference-category">
              <span class="empty" style=" line-height:30px; visibility:hidden"><br></span>
    ...
    <div class="col-md-2">
      <div class="reference-category">
      <a href="RiGrammar.php"><b>RiGrammar</b></a>

      <a href="RiGrammar/addRule/index.php">addRule()</a>
      <br>
      <a href="RiGrammar/expand/index.php">expand()</a>
      <br>
      <a href="RiGrammar/expandFrom/index.php">expandFrom()</a>
      <br>
      <a href="RiGrammar/expandWith/index.php">expandWith()</a>
      <br>
      <a href="RiGrammar/getGrammar/index.php">getGrammar()</a>
      <br>
      <a href="RiGrammar/hasRule/index.php">hasRule() </a>
      <br>
      <a href="RiGrammar/load/index.php">load()</a>
      <br>
      <a href="RiGrammar/loadFrom/index.php">loadFrom()</a>
      <br>
      <a href="RiGrammar/print/index.php">print()</a>
      <br>
      <a href="RiGrammar/ready/index.php">ready()</a>
      <br>
      <a href="RiGrammar/removeRule/index.php">removeRule() </a>
      <br>
    ...
    <div class="col-md-2">
      <div class="reference-category">
        <a href="RiMarkov.php"><b>RiMarkov</b></a>
        ...
        <br>
        <a href="RiMarkov/generateUntil/index.php">generateUntil()</a>
        <br>
        ...
        <br>
        <a href="RiMarkov/loadFrom/index.php">loadFrom()</a>
        <br>
        <a href="RiMarkov/loadText/index.php">loadText()</a>
        <br>
        <a href="RiMarkov/loadTokens/index.php">loadTokens()</a>
        <br>
    ...
    <div class="col-md-2">
      <div class="reference-category">
      <a href="RiString.php"><b>RiString</b></a>
        <a href="RiString/analyze/index.php">analyze()</a>
        <br>
        <a href="RiString/charAt/index.php">charAt()</a>
        <br>
        <a href="RiString/concat/index.php">concat()</a>
        <br>
        <a href="RiString/copy/index.php">copy()</a>
        <br>
        <a href="RiString/endsWith/index.php">endsWith()</a>
        <br>
        <a href="RiString/equals/index.php">equals()</a>
        <br>
        <a href="RiString/equalsIgnoreCase/index.php">equalsIgnoreCase()</a>
        <br>
        ...
        <br>
        <a href="RiString/lastIndexOf/index.php">lastIndexOf()</a>
        <br>
        <a href="RiString/length/index.php">length()</a>
        <br>
        <a href="RiString/match/index.php">match()</a>
        <br>
        <a href="RiString/pos/index.php">pos()</a>
        <br>
        <a href="RiString/posAt/index.php">posAt()</a>
        <br>
        <a href="RiString/removeChar/index.php">removeChar()</a>
        <br>
        <a href="RiString/replaceAll/index.php">replaceAll()</a>
        <br>
        <a href="RiString/replaceChar/index.php">replaceChar()</a>
        <br>
        ...
        <br>
        <a href="RiString/startsWith/index.php">startsWith()</a>
        <br>
        <a href="RiString/substr/index.php">substr()</a>
        <br>
        <a href="RiString/substring/index.php">substring()</a>
        <br>
        ...
        <br>
        <a href="RiString/trim/index.php">trim()</a>
        <br>
    ...
    <div class="col-md-2">
        ...
        <div class="reference-category">
          ...
          <!--a href="RiText.php"><b>RiText&nbsp;<span>(deprecated)</span></b></a-->
        </div>
