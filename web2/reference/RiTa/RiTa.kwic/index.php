				...
				<div class="span11">
					<table cellpadding="0" cellspacing="0" border="0" class="ref-item">
						...
						<tr class="">
							...
							<!-- DESCRIPTION  -->
							<td>Creates a Key-Word-In-Context (KWIC) model from a given text, a word to lookup, a wordCount and (optional) options</td>
						</tr>
						...
						<tr class='Syntax'>
							...
							<!-- SYNTAX  -->
							<td><pre>RiTa.kwic(text, word, options);</pre></td>
						</tr>
