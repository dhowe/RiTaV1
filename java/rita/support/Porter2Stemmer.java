 ...
 */
public class Porter2Stemmer implements StemmerIF {

  public Porter2Stemmer() {
    current = new StringBuffer();
  }

  public String stem(String s) {
    methodObject.setCurrent(s);
    methodObject.stem();
    return methodObject.getCurrent();
  }

  // ////////////////////////////////////////////////////////////////////////

  private final static Porter2Stemmer methodObject = new Porter2Stemmer();
  ...
  public boolean equals(Object o) {
    return o instanceof Porter2Stemmer;
  }

  public int hashCode() {
    return Porter2Stemmer.class.getName().hashCode();
  }
  ...
  protected int find_among(Among v[], int v_size) {
	...
	boolean res;
	try {
	  System.out.println("Invoke1: " + w.method.getName());
  ...
  protected int find_among_b(Among v[], int v_size) {
	...
	boolean res;
	try {
	  System.out.println("Invoke2: " + w.method.getName());
	  Object resobj = w.method.invoke(w.methodobject, new Object[0]);
	  res = resobj.toString().equals("true");
	} catch (Exception e) {
	  res = false;
...
class Among {
  ...
  public final Porter2Stemmer methodobject; /* object to invoke method on */
};