				...
				<div class="span11">
					<table cellpadding="0" cellspacing="0" border="0" class="ref-item">
						...
						<tr class="">
							...
							<!-- DESCRIPTION  -->
							<td>Returns String[] of Synsets for unique id</td>
						</tr>
						...
						<tr class='Syntax'>
							...
							<!-- SYNTAX  -->
							<td><pre>getSynset(id);<br/>getSynset(word, pos);<br/>getSynset(word, pos, includeOriginal);</pre></td>
						</tr>
