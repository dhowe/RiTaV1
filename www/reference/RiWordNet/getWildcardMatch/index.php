				...
				<div class="span11">
					<table cellpadding="0" cellspacing="0" border="0" class="ref-item">
						...
						<tr class="">
							...
							<!-- DESCRIPTION  -->
							<td>Returns up to maxResults of the specified pos matching a wildcard pattern, with '*' representing any number of characters, and '?' equals any single character..<br/>Example: 't?le' returns (tale,tile,tole)<br/>Example: 't*le' returns (tatumble, turtle, tussle, etc.)<br/>Example: 't?le*' returns (telex, tile,tilefish,tile,talent, tiles, etc.) </td>
						</tr>
						...
						<tr class='Syntax'>
							...
							<!-- SYNTAX  -->
							<td><pre>getWildcardMatch(pattern, posStr);<br/>getWildcardMatch(pattern, posStr, maxResults);</pre></td>
						</tr>
						...
						<tr class='Parameters'>
							...
							<table cellpadding="0" cellspacing="0" border="0" class="sub-table">
								<tr class=''><th width='25%' scope='row' class=nobold>String</th><td width='75%'>pattern</td></tr><tr class=''><th width='25%' scope='row' class=nobold>String</th><td width='75%'>posStr</td></tr><tr class=''><th width='25%' scope='row' class=nobold>int</th><td width='75%'>(optional) maxResults</td></tr>
							</table></td>
						</tr>
