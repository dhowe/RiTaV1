...
{ 
  /** offset to use for page numbers in the footer */
  public static int PAGE_NO_OFFSET = 35;
  ...
  public void footer(String footerText)
  {
    this.footer = new RiText(_pApplet, footerText, 
        textRectangle.x + textRectangle.w / 2f, textRectangle.y + textRectangle.h + PAGE_NO_OFFSET);
    footer.align(CENTER);
  }
