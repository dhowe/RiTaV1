...
{
<ff>
Sylvio finds a mahogony dining table in a warehouse housing cobwebs. It's an early wedding present. <tt>;
}

{
<tt>
(4 veal shanks, 2 tablespoons flour, 3 tablespoons unsalted butter);
(Bring veal shanks to room temperature. Preheat oven to 300 degrees);
...
The conductor says when the phase-somethng in the engine crosses over the changeover-something to a new energy company, the engine shuts off; First with the lights flickering on. Then the heat. Then the engine. Every inch counts.; Each hesitation reminds us we can stall at any moment. Every tunnel. Every bridge. Every distilled pace.  We are on the edge. We cry. We crawl.
}


{
<po>
The doorbell rings, The older female houseguest and I grab the doorknob. At the same time. I acquiesce and sit on the couch with my back to the door. I hear the door open. Voices in voluminous bass through my back.<kf>


Water drips from the ceiling. Everyone is upstairs. I call up but no answer. Another flood someone yells. They come downstairs to a pool of water. The mantel warped like a fish bowl castle. <f>
...
{
<lkl>
	In every home, comfort above all else should be highlighted. There is a beautiful Astroturf veranda for when I address the people of Argentina. Cheering in the CVS parking lot.<f>;<tt>;
}
{
<xy>
...
{
<bg>																																																
	We leave for a novelty store.  One is playing with a cap gun acting like a spy. Another is tapping me. On the shoulder for the fifth time. Hands me a present. I refuse. <f>

	We all gather at a diner booth to watch a man unwrap bandages from his head. Brain surgery scars. Tracks like a map over his skinless skull. We are more fascinated by his job as a taxi driver. Today, we just need a ride.

	<om> One seems to be in a hurry. Suspicious of the drivers�s abilities. How do you suppose to get us to the train station from here? <f> He makes the next left. I say, it's two blocks away. The taxi driver says, You certainly know your way around this town, I say, I certainly know my way out.; 
...
{
<om>
	<q>;(Car veering towards the airport of its own accord).;<zo>;
	<yy>;
	<f>;
...
{
<h>
Daddy missed our egg pie.<f> Daddy eats flan in Puerto rico. Takes a picture. Eats.  Captures the dirty dish. Daddy is good at accomodating requests. I should have asked for castanets.

<tt> Daddy arrives with tools. Straightens shelf. Drills brackets. Hooks projectors to ceilings. Upside down. From his toes. Like a bat.;	
}
...
{
<st>
	At Il Parco Sempione in Milano an old man drives on a bicycle with a basket. <om> He is wearing the perfect muted yellow shirt and the perfect muted yellow pants. <f>
	
	In the opposite direction a few meters further on a different lane, an old man in an off white shirt with dark brown pants.;
...
{
<c>
	I try to go back to sleep. When I wake I join the others in the dining room. 
	They are watching a film on a wide screen over the credenza. The film cuts to a close-up of Milan�s thigh.<f>;
}
{
<jd>
...
<df>
	...
	Yamato Wakakusa: Sweet red bean and soft rice cake wrapped with sponge cake.<f>
	Number 5 is Ayaichigo. This is an arrowroot jelly.<f>
	The middle has Sour-sweet Strawberry flavored bean paste <f>;
